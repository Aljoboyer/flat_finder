...
export const HeroSection = () => {
 ...
 <div className="h-screen w-full landing_hero_section pt-4 xsm:p-4">
        <div className="bg-white lg:w-2/3 xl:w-1/2 lg:ml-7 p-7 form_box">
            <div>
                <h1 className="md:text-xxl_title xsm:text-lg_title font-medium text-basecolor">Feel at home, <br/> free to roam</h1>
                <p className="">Experience the home that moves with you for a month, a year, or longer with a global network of designer, furnished apartments.</p>
            </div>
