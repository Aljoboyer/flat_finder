...
export default function page({params}) {
   ...
   console.log('property', isLoading)
  return (
    <div className='w-full'>
      {
        !property?.data ? <FFLoader/> :  
        <div className='w-full'>
              <div className=" lg:mx-auto md:mx-auto  lg:flex lg:flex-row md:flex md:flex-col sm:flex sm:flex-col px-2 md:px-4 lg:px-4 mt-4">
